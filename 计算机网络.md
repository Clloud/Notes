...
<img src=".\images\WKkKycQao8sPYlBq.png" alt="image-20200509124310614" style="zoom: 50%;" />

### 接收方产生粘包

数据包会暂存在接收方的接收缓冲区中，当接收数据的速度大于应用层取数据的速度时，前一个数据包还没有来得及读取，下一个数据包又被放入了缓冲区，这时读取数据就会读取到粘连在一起的数据包。

<img src=".\images\ae8TRCM9vbib04EN.png" alt="image-20200509124910376" style="zoom:60%;" />
...
<img src="E:\Files\Notes\images\46DvervwL2m0dNMn.png" alt="image-20200517120310294" style="zoom: 67%;" />